...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private static final float HALF_TRANSP = 0.3f;
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        int textPrimaryColor = context.getResources().getColor(com.aosip.owlsnest.R.color.material_deep_teal_500);
        int tabTextColor = context.getResources().getColor(com.aosip.owlsnest.R.color.material_deep_teal_500);
