...
import com.aosip.owlsnest.tabs.*;
import com.aosip.owlsnest.PagerSlidingTabStrip;

import java.util.ArrayList;
import java.util.List;

public class Owlsnest extends SettingsPreferenceFragment {
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        menu.add(0, MENU_HELP, 0, R.string.owlsnest_dialog_title)
                .setIcon(R.drawable.ic_owlsnest_info)
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case MENU_HELP:
                ...
                (R.string.owlsnest_dialog_toast),
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            switch (id) {
                case MENU_HELP:
                    ...
                    .setTitle(R.string.owlsnest_dialog_title)
                    .setMessage(R.string.owlsnest_dialog_message)
                    .setCancelable(false)
